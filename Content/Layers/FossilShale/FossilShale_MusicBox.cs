...
{
    internal class FossilShale_MusicBox : ModItem
    {
        public override void SetStaticDefaults()
        {
            ...
            MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Assets/Sounds/Music/FossilShaleOst"), ModContent.ItemType<FossilShale_MusicBox>(), ModContent.TileType<FossilShale_MusicBox_Tile>());
        }

        public override void SetDefaults()
        {
            Item.DefaultToMusicBox(ModContent.TileType<FossilShale_MusicBox_Tile>(), 0);
        }
    }
    public class FossilShale_MusicBox_Tile : ModTile
    {
        public override void SetStaticDefaults()
        {
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            player.cursorItemIconID = ModContent.ItemType<FossilShale_MusicBox>();
        }
