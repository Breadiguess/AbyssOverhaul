...
{
    internal class CyanobacteriaCarpet : ModTile
    {
        ...
        {
            GrassTexture = ModContent.Request<Texture2D>("AbyssOverhaul/Content/Layers/FossilShale/Tiles/CyanobacteriaCarpet");
            ...
            this.RegisterBlendMergeWith(ModContent.TileType<CarbonShale_Tile>());
            this.RegisterBlendMergeWith(ModContent.TileType<CyanobacteriaSludge_Tile>());
        }
        ...
        public override void ModifyLight(int i, int j, ref float r, ref float g, ref float b)
        {
            ...
            float brightness = 0.05f + t * 0.95f;

            r = (1f - 0.208f) * brightness;
            g = (1f - 0.134f) * brightness;
            b = (1f - 0.138f) * brightness;
        }
        ...
        public override void RandomUpdate(int i, int j)
        {
            ...
            /*
            if (    Terraria.WorldGen.genRand.NextBool(100))
            {
                ...
                Terraria.WorldGen.PlaceObject(i, j - 1, Terraria.WorldGen.genRand.Next(Lillies), true);
            }
            */
            //convert this tile back into scorched remains if any liquid is above it
            //will change this to only check for lava if necessary
            ...
            {
                //Main.tile[i, j].TileType = (ushort)ModContent.TileType<cyan>();
            }
